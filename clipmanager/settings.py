...
class Settings(QtCore.QObject):
    ...
    def get_max_entries_enabled(self):
        return int(self.q_settings.value('maxentries', 1))

    def set_max_entries_enabled(self, value):
        logging.debug(value)
        self.q_settings.setValue('maxentries', int(value))
